const AboutIntro= () => (
    <section className="bg-white mx-[40px] mt-[40px] mb-[40px]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 xl:gap-16 px-2 sm:px-4 xl:px-8">
