...
const CallToActionSection = () => (
  <section className="bg-white py-10 sm:py-16 xl:py-24 text-center px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32">
    <h2 className="text-xl sm:text-2xl md:text-3xl xl:text-4xl font-bold mb-4 xl:mb-6">Elevate Your Future with Crownlinks Academy</h2>
    <p className="text-base sm:text-lg md:text-xl xl:text-2xl text-gray-700 mb-8 xl:mb-12">
