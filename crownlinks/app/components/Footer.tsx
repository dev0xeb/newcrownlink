...
const Footer = () => {
  return (
    <footer className="bg-[#1A6EDC] py-12 sm:py-16 lg:py-20">
      <div className="max-w-9xl mx-auto px-6 sm:px-8 lg:px-20 grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-12">
        ...
        <div className="col-span-1">
          <h3 className="font-bold text-white text-lg sm:text-xl mb-4">Features</h3>
        ...
        <div className="col-span-1">
          <h3 className="font-bold text-white text-lg sm:text-xl mb-4">Help Center</h3>
          <ul className="space-y-2 text-white text-sm sm:text-base">
        ...
        <div className="col-span-1">
          <h3 className="font-bold text-white text-lg sm:text-xl mb-4">Contact Info</h3>
          <p className="text-white text-sm sm:text-base">Call Us: 07539382444</p>
          <p className="text-white text-sm sm:text-base">Mail us: ade@crownlinksinternational.com</p>
        </div>
      </div>
    </footer>
  );
