const Footer = () => (
  <footer className="bg-white border-t border-gray-200 py-12 px-4 sm:px-8 md:px-16 mt-8">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12 md:gap-8">
      ...
      <div className="flex-1 mb-8 md:mb-0 flex flex-col items-start">
        <div className="flex items-center mb-4">
          ...
          <span className="font-bold text-2xl md:text-3xl text-[#1976d2]">CROWNLINKS</span>
        </div>
      ...
      {/* Right: Links */}
      <div className="flex-[2] grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-8 md:gap-12">
        <div>
          <h4 className="font-semibold mb-3 text-lg md:text-xl">Features</h4>
          <ul className="text-gray-600 text-base md:text-lg space-y-2">
            <li>Courses</li>
            <li>About Us</li>
        ...
        <div>
          <h4 className="font-semibold mb-3 text-lg md:text-xl">Help Center</h4>
          <ul className="text-gray-600 text-base md:text-lg space-y-2">
            <li>Support</li>
            <li>Get Help</li>
        ...
        <div>
          <h4 className="font-semibold mb-3 text-lg md:text-xl">Contact Info</h4>
          <ul className="text-gray-600 text-base md:text-lg space-y-2">
