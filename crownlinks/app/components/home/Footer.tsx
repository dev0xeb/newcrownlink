...
const Footer = () => (
  <footer className="bg-[#1A6EDC] py-12 sm:py-16 lg:py-20 px-4 sm:px-8 md:px-12 lg:px-20">
    <div className="max-w-9xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
      ...
      <div className="col-span-1">
        ...
        <ul className="space-y-2 text-white text-sm sm:text-base md:text-lg">
      ...
      <div className="col-span-1">
        ...
        <p className="text-white text-sm sm:text-base md:text-lg">Call Us: 07539382444</p>
        <p className="text-white text-sm sm:text-base md:text-lg">Mail us: ade@crownlinksinternational.com</p>
      </div>
    </div>
  </footer>
);
