...
const CtaSection = () => {
  return (
    <section className="bg-gray-50 py-16 sm:py-24 lg:py-32 px-4 sm:px-6 md:px-12 lg:px-8 text-center">
      <div className="max-w-9xl mx-auto px-6 sm:px-8 md:px-12 lg:px-20">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#242424] mb-6 leading-tight">
